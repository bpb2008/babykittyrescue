            ...
            <article className="bg-white p-6 md:p-10 shadow-md rounded-md flex-1">
              ...
              <section className="space-y-6 text-base text-[#221a20]">
                <div>
                  ...
                  <p>
                    ...
                    blanket. Ensure some space for kittens to step away. Keep
                    them away from water to prevent chills. Only clean with a
                    damp washcloth and immediately dry with towel or hair dryer
                    on low.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Kitten formula is easily available. Warm the KMR lightly,
                    and use kitten bottles, with elongated nipples and punch
                    your own holes in them with a sterilized pin so it drips out
                    easily. Adjust the holes with every kittens needs.
                  </p>
                  <p>
                    Hold or place kittens on their stomachs and tilt the bottle
                    so less air gets in. Do not feed kittens on their backs.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Kittens on formula need burping. Slide them over your
                    shoulder or put them on their stomachs and gently pat until
                    you hear them burp it out.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    will stimulate urination & excretion. If your little ones
                    have trouble defecating, check with a veterinarian.
                  </p>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    ...
                    difficulty breathing/eating. In such cases, immediately see
              ...
              <div className="mt-10">
                <ShareButtons
                  ...
                  url="https://babykittyrescue.netlify.app/resources/care"
                />
              </div>
            </article>
