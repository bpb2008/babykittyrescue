    ...
    <div>
      ...
      <div className="relative h-screen flex flex-col justify-between text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full px-4 md:px-16">
          <div className="flex flex-col lg:flex-row justify-around items-center w-full max-w-7xl gap-8">
            <div className="text-center lg:text-left lg:w-1/2">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl mt-8 font-extrabold leading-tight text-white">
                EVEN YOUR <br />
                SMALLEST <br />
                CONTRIBUTION <br />
                CAN MAKE A BIG <br />
