            ...
            <article className="bg-white p-6 md:p-10 shadow-md rounded-md flex-1">
              ...
              <section className="space-y-6 text-base text-[#221a20]">
                <div>
                  ...
                  <p>
                    Newly born cats, like every other being, thrive best on
                    their mother’s milk. However, some unfortunate creatures
                    like abandoned or orphaned kittens, need a replacement. That
                    is why we have kitten formula, such as kitten milk replacer
                    (KMR).
                  </p>
                  <p>
              ...
              <div className="mt-10">
                <ShareButtons
                  ...
                  url="https://babykittyrescue.netlify.app/resources/feeding"
                />
              </div>
            </article>
